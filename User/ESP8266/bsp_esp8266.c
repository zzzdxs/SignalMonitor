...
{
	//PC->USART1->USART3->ESP8266->USART3->USART1->PC
...
static void ESP8266_GPIO_Config ( void )
{
  ...
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;   
	...
	GPIO_Init ( macESP8266_CH_PD_PORT, & GPIO_InitStructure );//PE2

	/* 配置 RST 引脚*/
	macESP8266_RST_APBxClock_FUN ( macESP8266_RST_CLK, ENABLE ); //PG15
